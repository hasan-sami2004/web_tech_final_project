...
session_start();
require_once __DIR__ . "/../controller/searchBookController.php";
?>
...
<nav class="top-nav">
  <div class="logo">🔍 <b>WEBTECH LIBRARY — SEARCH BOOK</b></div>
...
<form method="GET">
  <input type="text" name="search" placeholder="Search by book title or author" required>
